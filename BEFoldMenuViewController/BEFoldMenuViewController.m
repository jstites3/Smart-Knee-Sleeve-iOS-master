...
- (void)viewDidLoad {
    ...
    self.kneeAngle = [[UILabel alloc] initWithFrame:CGRectMake(55, 30, 75, 50)];
    [self.kneeAngle setTextColor:[UIColor whiteColor]];
    [self.kneeAngle setText:[NSString stringWithFormat:@"%i", 0]];
    [self.kneeAngle setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:28]];
    [self.heartImage addSubview:self.kneeAngle];
    
    // Scan for all available CoreBluetooth LE devices
    NSArray *services = @[[CBUUID UUIDWithString:NRF52_DEVICE_INFO_UUID], [CBUUID UUIDWithString:NRF52_DEVICE_INFO_UUID]];
...
// Instance method to get the knee angle measurement information
