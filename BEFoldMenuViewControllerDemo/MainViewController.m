...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightBtn = [[UIBarButtonItem alloc] initWithTitle:@"MyData" style:UIBarButtonItemStylePlain target:self action:@selector(buttonRightMenuTapped)];
